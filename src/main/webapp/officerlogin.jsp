...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('loginimg.jpg'); /* Specify the path to your background image */
        ...
        <%
            ...
            if(loginUsername != null && loginPassword != null) {
                try {
                    ...
                    PreparedStatement stmt = conn.prepareStatement("SELECT * FROM officer WHERE officername = ?");
                    ...
                    if(rs.next()) {
                        ...
                        if(loginPassword.equals(dbPassword)) {
                            ...
                            response.sendRedirect("welcome_officer.html");
                        } else {
